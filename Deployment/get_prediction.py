...
def get_recommendations(X=None):
    ...
    ulp = pd.read_pickle("Derived_data/user_last_purchase.pkl")
    if user_id not in ulp['user_id'].values:
        # get top 5 products based on hour of day and day of week
        top = pd.read_pickle('Derived_data/top10_products.pkl')
    ...
    hour_rate = pd.read_pickle("Derived_data/hour_reorder_rate.pkl")
    day_rate = pd.read_pickle("Derived_data/day_reorder_rate.pkl")
    p_days_rate = pd.read_pickle("Derived_data/p_days_since_prior_order_reorder_rate.pkl")
    u_days_rate = pd.read_pickle("Derived_data/u_days_since_prior_order_reorder_rate.pkl")
    up_days_rate = pd.read_pickle("Derived_data/days_since_prior_reorder_rate.pkl")

    merged_up_features = pd.read_pickle("Derived_data/Updated_final_dataset.pkl")
    ...
    if p_days.empty:
        ...
        products_x = pd.read_pickle('Derived_data/product_mappings.pkl')
